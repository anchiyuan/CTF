...
%% predict CTF with Wiener filter (A) %%
start_ini_frame = L;
...
% 
% A_dB = mag2db(abs(IMPULSE));
% % 畫 A frequency plot %
% figure(6);
% mesh(1:1:102, 1:1:513, A_dB)
% colorbar
% xlabel('frame')
% ylabel('frequency(Hz)')
% zlabel('dB')
...
% 
% source_MINT_filemane_str = ['wav\source_predict_all_Wiener_MINT-', string(reverberation_time), '.wav'];
