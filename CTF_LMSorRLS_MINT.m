...
%             Y_delay_choose = Y_delay(n, FrameNo, i);
%             error(i, FrameNo-start_ini_frame+1, n) = Y_delay_choose - weight'*Y_DAS_choose;
...
% 
% source_MINT_filemane_str = ['wav\source_predict_all_RLS_MINT-', string(reverberation_time), '.wav'];
